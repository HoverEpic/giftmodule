...
class Gift extends CommonObject
{
	...
	public $fields=array(
		...
		'sign' => array('type'=>'varchar(128)', 'label'=>'Signature', 'visible'=>-1, 'enabled'=>1, 'position'=>50, 'notnull'=>-1, 'comment'=>"Giver signature",),
		'photo' => array('type'=>'varchar(128)', 'label'=>'Photo', 'visible'=>-1, 'enabled'=>1, 'position'=>50, 'notnull'=>-1, 'comment'=>"Given items picture",),
	);
	public $rowid;
	public $ref;
	public $entity;
