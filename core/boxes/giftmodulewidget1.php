...
/**
 * \file    modulebuilder/template/core/boxes/giftmodulewidget1.php
 * \ingroup giftmodule
 * \brief   Widget provided by GiftModule
 *
 ...
 */
class giftmodulewidget1 extends ModeleBoxes {

    /**
     * @var string Alphanumeric ID. Populated by the constructor.
     */
    public $boxcode = "giftmodulebox";

    /**
     * @var string Box icon (in configuration page)
     * Automatically calls the icon named with the corresponding "object_" prefix
     */
    public $boximg = "giftmodule@giftmodule";
     ...
     */
    public $depends = array('giftmodule');
    ...
    public function __construct(DoliDB $db, $param = '') {
        ...
        $this->boxlabel = $langs->transnoentitiesnoconv("GiftModuleWidget");

        $this->param = $param;

        //$this->enabled = $conf->global->FEATURES_LEVEL > 0;         // Condition when module is enabled or not
        //$this->hidden = ! ($user->rights->giftmodule->myobject->read);   // Condition when module is visible by user (test on permission)
    }
    ...
    public function loadBox($max = 5) {
        ...
        //include_once DOL_DOCUMENT_ROOT . "/giftmodule/class/giftmodule.class.php";
        // Populate the head at runtime
        $text = $langs->trans("GiftModuleWidgetDescription", $max);
        $this->info_box_head = array(
            // Title text
            'text' => $text,
            // Add a link
            'sublink' => '/custom/giftmodule/gift_list.php',
            // Sublink icon placed after the text
            'subpicto' => 'object_giftmodule@giftmodule',
