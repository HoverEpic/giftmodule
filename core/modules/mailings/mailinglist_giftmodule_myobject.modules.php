...
dol_include_once("/giftmodule/class/myobject.class.php");


/**
 * mailing_mailinglist_giftmodule
 */
class mailing_mailinglist_giftmodule_myobject extends MailingTargets
{
	// CHANGE THIS: Put here a name not already used
	var $name='mailinglist_giftmodule_myobject';
	...
	var $picto='giftmodule@giftmodule';
	var $db;
	...
	function __construct($db)
	{
		...
		{
			$this->enabled=in_array('giftmodule',$conf->modules)?1:0;
		}
	}
	...
	function url($id)
	{
		return '<a href="'.dol_buildpath('/giftmodule/myobject_card.php',1).'?id='.$id.'">'.img_object('',"generic").'</a>';
	}
	...
	function add_to_target($mailing_id,$filtersarray=array())
	{
		...
		if ($result)
		{
			...
			dol_syslog("mailinglist_giftmodule_myobject.modules.php: mailing ".$num." targets found");
