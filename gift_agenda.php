...
/**
 *  \file       gift_agenda.php
 *  \ingroup    giftmodule
 *  \brief      Page of Gift events
 */
...
$hookmanager->initHooks(array('giftagenda'));     // Note that conf->hooks_modules contains array
...
if ($object->id > 0)
{
	...
	dol_fiche_head($head, 'agenda', $langs->trans("Gift"), -1, 'gift@giftmodule');
    ...
    if (! empty($conf->agenda->enabled) && (!empty($user->rights->agenda->myactions->read) || !empty($user->rights->agenda->allactions->read) ))
    {
		...
		print load_fiche_titre($langs->trans("ActionsOnGift"),'','');
