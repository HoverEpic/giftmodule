...
/**
 * \file    test/functional/GiftModuleFunctionalTest.php
 * \ingroup giftmodule
...
/**
 * Class GiftModuleFunctionalTest
 *
 ...
 *
 * @package Testgiftmodule
 */
class GiftModuleFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
...
//        )
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modGiftModule')->click();
		} else {
			// Disable the module
			$this->byHref('modGiftModule')->click();
			// Reenable the module
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('giftmodulewidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modGiftModule_GiftModuleTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modGiftModule_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
